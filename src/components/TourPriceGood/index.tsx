import CinemaSystem from "../TourType"
...
const TourPriceGood = () => {
	return <div className=" scroll-margin-top bg-gray-50 bg-contain bg-bottom bg-no-repeat py-8 md:py-10 lg:py-14 flex flex-col justify-center items-center p-28">
      ...
      <div className=" text-center text-[30px] font-bold text-[#d82f8b]">Tour Du Lịch Trải Nghiệm</div>
			<p className="mb-5 text-center text-[#003C71]">Mới Lạ, An Toàn, Linh Hoạt</p>
